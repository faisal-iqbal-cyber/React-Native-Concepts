...
function List({navigation,route}){
    ...
    async function fetchProducts(){
        const response = await fetch(`https://my-application-4b743-default-rtdb.firebaseio.com/product.json/${id}.json`);
    ...
    function handleUpdate(){
      ...
      fetch(`https://my-application-4b743-default-rtdb.firebaseio.com/product/${id}.json`,{
