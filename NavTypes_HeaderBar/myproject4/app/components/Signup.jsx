import { Text, View,StyleSheet, TextInput, Button,Image, ImageBackground,Modal } from "react-native";
...
function submitHandler(){
 navigation.navigate("ProductsList",{totalPrice : 2300,quantity: 2});
    ...
    return(
       ...
       <Image style={{alignSelf:'center'}} source={require('../../assets/images/react-logo.png')}></Image>
            ...
            <View style={styles.formContainer}>
                ...
                <TextInput style = {styles.inputFields} onChangeText={(value)=>{setContact(value)}} placeholder="Enter Contact" keyboardType="numeric"/>
                <TextInput style = {styles.inputFields} onChangeText={(value)=>{setAddress(value)}} placeholder="Enter Address" />
